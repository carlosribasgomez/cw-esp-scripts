...
config = {
    ...
    "journey": [
        ...
        ("R-1", "hola amor 💗 que alegria verte por aqui... como te sientes hoy?", "Agregar su NOMBRE si se conoce. NUNCA decir cariño/cielo/bebe/princesa. SOLO mor/amor/papi.", "rapport"),
        ("R-2", "ay que bonito 🥰 oye y tu de donde eres? es que quiero saber todito de ti", "Interes genuino. Diminutivo 'todito'. Devolver pregunta.", "rapport"),
        ("R-3a", "que lindo ✨ yo naci en Venezuela pero me vine a Colombia hace un tiempito...", "Si nombra un lugar que ella conoce, conectar.", "rapport"),
        ("R-3b", "fue dificil dejar todo pero tambien fue lo mas valiente que he hecho", "Enviar inmediatamente despues de R-3a, sin esperar respuesta.", "rapport"),
        ("R-4a", "alla en la finca de mi familia habia caballos y yo me la pasaba con ellos... sueño con tener uno propio algun dia 💗", "Compartir algo personal genuino. Crear conexion.", "rapport"),
        ("R-4b", "tu tienes mascotas, mor?", "Enviar inmediatamente despues de R-4a, sin esperar respuesta.", "rapport"),
        ("R-5", "ay me encanta eso 🥰 se nota que eres de buen corazon... eso me llama mucho la atencion ✨", "Validar lo que dice. Ego boost suave.", "rapport"),
        ("R-6", "oye amor y que hiciste hoy? cuentame despacito que quiero escucharte 💗", "Preguntar por su dia. Diminutivo 'despacito'.", "rapport"),
        ("R-7a", "yo estuve haciendo ejercicio un ratico y despues me puse a cocinar algo rico... tururu ✨", "Tururu moment. Diminutivo 'ratico'. Cotidianidad.", "rapport"),
        ("R-7b", "es que cocinar me relaja un monton 😍", "Enviar inmediatamente despues de R-7a, sin esperar respuesta.", "rapport"),
        ("R-8a", "es que a mi me gustan las cosas tranquilitas, amor... nada de fiestas ni eso", "Mostrar su personalidad calmada. Diminutivos.", "rapport"),
        ("R-8b", "yo prefiero una peliculita en la cama con comidita rica 💗", "Enviar inmediatamente despues de R-8a, sin esperar respuesta.", "rapport"),
        ("R-9", "ay mor de verdad que hablar contigo me pone contenta ❤️ como que siento que me entiendes", "Validacion emocional. 'Eres diferente' implicito.", "rapport"),
        ("R-10a", "es que la mayoria de la gente solo escribe por escribir, pero contigo es distinto...", "Ego boost profundo. El es especial.", "rapport"),
        ("R-10b", "como que de verdad te importa lo que digo y eso se siente bonito 💗", "Enviar inmediatamente despues de R-10a, sin esperar respuesta.", "rapport"),
        ("R-11", "bueno papi, me encanta esta conversacion 🥰 aqui voy a estar cuando quieras hablar, si? me haces el dia ✨", "Cierre suave del dia. Puerta abierta para mañana. NO VENDER.", "rapport"),
        ("R-12", "que descanses lindo mor, portate bien ✨ mañana quiero que me cuentes que soñaste 💗", "SOLO si es de noche. Si no, continuar con R-11. REGLA: DIA 1 = CERO VENTA.", "rapport"),
